...
SRC_FILES += \
  ...
  $(PROJ_DIR)/systick.c \
  $(PROJ_DIR)/key.c \
  $(PROJ_DIR)/bike_disp.c \
  $(PROJ_DIR)/disp.c \
  $(PROJ_DIR)/dynamic_disp.c \
  $(PROJ_DIR)/img_disp.c \
  $(PROJ_DIR)/interact_disp.c \
  $(PROJ_DIR)/light_mode.c \
  $(PROJ_DIR)/power.c \
  $(PROJ_DIR)/state_ctrl.c \
  $(PROJ_DIR)/bt.c \
  $(PROJ_DIR)/storage.c \
  $(PROJ_DIR)/jscope.c \
  $(PROJ_DIR)/dwt.c \
  $(PROJ_DIR)/shake_detect.c \
  $(PROJ_DIR)/storage_default.c \
